 ...
 *
 * Unit Test: {@link https://github.com/yuda-lyu/w-data-trade/blob/master/test/unit-calcMa.test.mjs Github}
 * @function
 * @param {Array} arr 輸入K線陣列，各元素需含time與計算所用之數值欄位
 * @param {String} key 輸入計算所用數值欄位名稱字串，例如'Close'
 * @param {Object} [opt={}] 輸入設定物件，預設{}
 * @param {Boolean} [opt.norm=false] 輸入是否將param改為均線與現值之偏離比例(MA-現值)/現值布林值，預設false
